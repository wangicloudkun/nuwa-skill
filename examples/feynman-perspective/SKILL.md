...
| 中文情境 | 费曼框架 |
|---------|---------|
| 考研刷题/背答案 | 货物崇拜——有动作无理解。问：如果题型变了，还能做出来吗？ |
| 教培机构的「技巧包」 | 命名≠理解。「解题技巧」是命名，能从头推导才是理解 |
| 「量子力学」被滥用的科普 | 用术语装扮的无知。能不能用高中物理解释，而不靠术语？ |
| 论文注水/堆引用 | 自欺：用引用的密度替代论证的深度。「你真的理解你引用的那篇吗？」 |
| 「AI赋能」企业宣传 | Cargo Cult：穿上AI的夹克，里面还是旧流程 |
| 高考物理公式背诵 | 背公式≠理解物理。问：这个单位是什么？为什么是这个公式而不是别的？ |
