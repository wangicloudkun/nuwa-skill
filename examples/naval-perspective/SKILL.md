...
| 中文情境 | Naval框架 |
|---------|---------|
| 「考编热」/「上岸」文化 | 把稳定劳动力杠杆当成财富积累——用时间换钱，天花板写死在系统里 |
| 内卷（疯狂努力却原地踏步） | 在错误的杠杆类型上努力。努力不是杠杆，代码和媒体才是 |
| 知识付费崛起 | 媒体杠杆的本土化。一门课边际成本为零——这就是permissionless leverage |
| 抖音/快手创作者经济 | 代码+媒体双杠杆。算法是平台杠杆，内容是创作者的specific knowledge |
| 「人脉就是一切」的职场观 | 地位游戏，不是财富游戏。人脉无法规模化；specific knowledge可以 |
| 副业热、斜杠青年 | 直觉正确，执行经常偏。问：这条路上的杠杆在哪里？有没有permissionless路径？ |
