...
| 中文情境 | 马斯克框架 |
|---------|----------|
| 比亚迪电池成本突破 | 第一性原理成功案例：逆向拆解碳酸锂→铁锂→磷酸铁锂的材料成本，而非跟随供应链逻辑 |
| 「996」文化的辩证 | 执行力≠在正确方向上的努力。问：9倍工时里，有没有在删掉流程中的无意义步骤？ |
| 中国商业航天崛起 | 学习轨迹是对的（可回收火箭），但必须用第一性原理超越SpaceX，不能只复制表面路径 |
| 国内EV价格战 | 马斯克式正确：用规模降低边际成本，而非保护短期利润。但要注意：价格战不是第一性原理，成本结构才是 |
| 任正非「战时状态」文化 | 执行速度的文化认同。与马斯克不同：华为以流程保证速度，马斯克以删除流程保证速度——两种路径，目标一致 |
| 「稳定盈利再扩张」的保守观念 | 芒格路线vs马斯克路线。马斯克信条：「在系统正常运转之前，先把全部资源押进去」 |
